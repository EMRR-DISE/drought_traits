...
# if necessary -----
fmwt1 <- read_csv("fish traits/fish_data/fmwt1.csv") # derived from fmwt.R, collapsed striper data
index_stations <- read_csv("fish traits/fish_data/index_stations.csv") # from fmwt.R
spp_occ <- read_csv("fish traits/fish_data/spp_occ.csv")
year_types <- read_excel("fish traits/fish_data/yeartypes.xlsx") %>% select(-...1)
